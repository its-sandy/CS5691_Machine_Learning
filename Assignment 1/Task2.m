...
for N = [20,40,100]
    X = sort(rand(N, 1));
    X2 = sort(rand(N/4, 1));%test data is 20% of total data
...
figure('Name', sprintf('Polynomial Curve Fitting %d %d %d',N,bM,bL), 'NumberTitle', 'off');
plot(btrainY, bphi*bw, 'bo'); hold on
